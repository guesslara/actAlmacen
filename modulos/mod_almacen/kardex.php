...
$sql_cardex="SELECT mov_almacen.id_mov, concepmov.id_concep, concepmov.concepto,mov_almacen.asociado, mov_almacen.fecha, prodxmov.cantidad, prodxmov.cu, catprod.id_prod, catprod.descripgral
