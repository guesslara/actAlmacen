...
<div style="text-align:right"><a href="../reportes/nx_costos_totales2.php" style=" text-decoration:none;">Exportar a Excel</a></div><br />
<table align="center" width="auto" style="border:#000000 2px solid;" cellspacing="0" cellpadding="1">
  <tr style="text-align:center; font-weight:bold; font-size:14px; background-color:#333333; color:#FFFFFF;">
    <td height="20" colspan="24" style="border-bottom:#000000 2px solid;">CAT&Aacute;LOGO DE PRODUCTOS NEXTEL (<?=$ndr?> Resultados) </td>
  </tr>
  <tr style="text-align:center; font-weight:bold; font-size:11px; background-color:#CCCCCC;">
    ...
    <td rowspan="2" style="border-bottom:#000000 2px solid;">DESC.INGL&Eacute;S </td>
  ...
  <tr bgcolor="<?=$color?>">
    ...
    <td style=" border-right:#CCCCCC 1px solid;">&nbsp;<?=$row["observa"]?></td>
  ...
  <tr bgcolor="<?=$color?>" style="font-weight:bold; font-size:14px; text-align:right;">
    <td colspan="8" style=" border-right:#000000 2px solid;">TOTAL</td>
