...
<?php 	$sql7="SHOW COLUMNS FROM catprod FROM dbiqcd LIKE 'a_%' ";
		//echo $sql;
		$result7=mysql_db_query($sql_db,$sql7);
		$i2 = 1;
  		while ($row=mysql_fetch_array($result7)) {
			//determinando almacenes asociados
			$alm7=$row[0];
			$sql_alm7="SELECT count(id_prod) as existe FROM catprod WHERE id_prod='$id_prod' and $alm7='1'";
