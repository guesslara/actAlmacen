<?
	...
	switch($_POST['action']){
		...
		case "guardaEquipoEmpaqueFinal":
			...
			$idValidacionAgrupada=$_POST["idValidacionAgrupada"];
			...
			$objEnsamble->verificarPO($idEntregaInterna,$conceptoEntrega,$modelo,$usrEmpaque,$idElemento,$valores,$numeroCaja,$cantidadCapturada,$idModeloCaptura,$poAValidar,$idValidacionAgrupada);
		break;
		...
		break;
		case "marcarEquiposEnviados":
			//print_r($_POST);
			include("finalizarEquipos.php");
			$objFinalizarEquipos=new finalizarEquipos();
			$objFinalizarEquipos->marcarEquiposEnviados($_POST["idEntregaInterna"],$_POST["conceptoEntrega"],$_POST["idUsuarioActual"],$_POST["procesoEnvio"]);
		break;
		case "mostrarInfoEntrega":
			//print_r($_POST);
			include("modelo2Empaque.php");
