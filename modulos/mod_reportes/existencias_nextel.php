...
<div style="text-align:left"><a href="existencias_nextel_excel.php" style=" text-decoration:none;">&nbsp;Exportar a Excel</a></div><br />
<table align="center" width="auto" style="border:#000000 2px solid;" cellspacing="0" cellpadding="1">
  <tr style="text-align:center; font-weight:bold; font-size:14px; background-color:#333333; color:#FFFFFF;">
    <td height="20" colspan="16" style="border-bottom:#000000 2px solid;">CAT&Aacute;LOGO DE PRODUCTOS NEXTEL (<?=$ndr?> Resultados) </td>
  </tr>
