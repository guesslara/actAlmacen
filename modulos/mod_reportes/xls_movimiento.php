...
$lista_campos=" id,`id_prod`,`descripgral`,`especificacion`";
		...
		if($trows==0){
			...
			$sql_detalle_movimiento="SELECT mov_almacen.id_mov,mov_almacen.fecha,mov_almacen.tipo_mov,mov_almacen.almacen,mov_almacen.referencia,mov_almacen.asociado,mov_almacen.observ, tipoalmacen.almacen,tipoalmacen.id_almacen, concepmov.id_concep,concepmov.concepto,concepmov.asociado AS dasociado FROM mov_almacen,tipoalmacen,concepmov WHERE mov_almacen.tipo_mov=concepmov.id_concep AND mov_almacen.almacen=tipoalmacen.id_almacen AND mov_almacen.id_mov=$id_movimiento_recibido";
			if ($result_detalle_movimiento=mysql_db_query($sql_db,$sql_detalle_movimiento))
			{
				...
				{
					//echo "<br>";	print_r($row_detalle_movimiento);
					// ========================================================================================================================
					// PROVEEDOR ...
