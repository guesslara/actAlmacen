...
$valor_total_inventario=$valor_almacen1+$valor_almacen44+$valor_almacen77;
  ...
  <div id="div01">
      ...
      <div id="div012">
            ...
            <tr>
                ...
                <td class="detalle">
					<a href="existencias.php">ver</a> | 
					<!--
					<a href="existencias_detalle.php" title="Ver Costo Unitario.">CU ($)</a> 
					//-->
					<a href="xls_costos_unitarios.php" title="Exportar Costo Unitario a Excel."><img alt="XLS" src="../img/excel.png" border="0" /></a>
				</td>
            </tr>
            <tr>
			...
			<tr>
            	<td class="concepto">77. Refacciones Nuevas Nextel</td>
                <td class="monto"><?=number_format($valor_almacen77,2,'.',',')?>&nbsp;</td>
                <td class="porcentaje"><?=round($porc_almacen77,2)?>&nbsp;</td>
