...
header("Content-Disposition: attachment; filename=valor_inventario_status_$fecha.xls");
...
$sql="
SELECT 
	catprod.id AS idp, catprod.id_prod AS claveX, catprod.descripgral, catprod.especificacion, catprod.control_alm, catprod.status1,  catprod.linea,  sum(prodxmov.existen*prodxmov.cu) AS total_existencias
...
ORDER BY catprod.status1 ASC, prodxmov.id_prod ASC
