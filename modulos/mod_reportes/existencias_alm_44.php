...
<title>Valor del Inventario - Almacen 44</title>
</head>

<body>
<?php include("../menu/menu.php"); 
//echo "<br>".
$sql="SELECT id,id_prod,descripgral,especificacion,exist_44 from catprod where exist_44>0 order by id";
if($res=mysql_db_query($sql_db,$sql,$link)){
	...
	<tr style=" font-weight:bold; text-align:center; background-color:#333333; color:#FFFFFF; ">
	  <td colspan="6" height="20">Valor del Inventario del Almacen 44 (<small>mostrando <?=$Resultados?> resultados</small>).</td>
  </tr>
	...
	while($reg=mysql_fetch_array($res)){
		...
		<tr bgcolor="<?=$color?>">
			...
			<td align="right"><?=$reg["exist_44"]?></td>
