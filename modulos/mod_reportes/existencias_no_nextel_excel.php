<?php 
	...
	header("Content-Disposition: attachment; filename=CATALOGO DE PRODUCTOS NEXTEL $fecha.xls");
...
<table align="center" width="auto" cellspacing="0" cellpadding="1">
  <tr style="text-align:left; font-weight:bold; text-align:center; font-size:14px;">
    <td height="20" colspan="15" style="">CAT&Aacute;LOGO DE PRODUCTOS NO NEXTEL (<?=$ndr?> Resultados) </td>
  </tr>
