...
function obtener_valor_inventario(){
	...
	where 
		...
		AND concepmov.tipo='Ent' 
			AND mov_almacen.almacen=48
		AND catprod.exist_48>0		
...
<title>Valor del Inventario - Almacen 48 (Resumen)</title>
</head>
...
<p>&nbsp;</p>
<p style="text-align:center; font-weight:bold; font-size:12px;">Valor Total del Inventario en el Almacen 48:</p> 
