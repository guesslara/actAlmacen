...
?>
  <form id="form1" name="form1" method="post" action="tipo_alm.php">
    <p><table width="346" border="0" align="center" cellspacing="1">
      <tr>
        <td colspan="2" style="background-color:#333333; font-weight:bold; text-align:center; color:#FFFFFF;">Nuevo Almac&eacute;n</td>
      </tr>
      <tr>
...
<?
		...
		include("../conf/conectarbase.php");
				...
				//echo $creatabla;
				$result=mysql_db_query($sql_db,$indice);
				$row=mysql_fetch_array($result);
				$i=$row[0];
				//+++++++++++++++++++++++++++++++++++++++++++++++++++
				$creacampo="ALTER TABLE `catprod` ADD `a_".$i."_".$almacen."` VARCHAR( 10 ) NOT NULL DEFAULT '0',ADD `exist_".$i."` FLOAT( 11 ) NOT NULL DEFAULT '0',ADD `trans_".$i."` FLOAT( 11 ) NOT NULL DEFAULT '0'";
				mysql_db_query($sql_db,$creacampo);
				//echo $creacampo;
